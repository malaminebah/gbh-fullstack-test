...
export const VehiculeCard = ({ vehicule }: VehiculeCardProps) => {
  ...
  return (
    <>
      <div
        className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col h-full cursor-pointer"
      ...
      >
        ...
        <div className="p-4 flex flex-col flex-grow">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-sm text-gray-500">{vehicule.year}</span>
          </div>
